...
export const QuizPage = () => {
  ...
  useEffect(() => {
    const hw = findHomework(homeworkId)
    if (hw) {
      setHomework(hw)
    } else {
  ...
  const handleSubmit = () => {
    ...
    if (!window.confirm('Are you ready to submit your exam? You cannot change your answers later.')) {
      return
    }
    ...
    <div className="quiz-page fade-in">
      ...
      <nav className="quiz-topbar">
        <div className="topbar-left-section">
          ...
          <div className="quiz-title-box">
             ...
             <p className="quiz-status-text">ASSESSMENT</p>
          </div>
        </div>
      ...
      <div className="quiz-main-container">
        ...
        <div className="instruction-card">
           <h1>Instructions</h1>
           <p>
             {homework.description || 'Answer all questions carefully. You must complete the entire assessment to submit.'}
           </p>
        </div>
        ...
        {homework.questions?.map((q, index) => (
          <div key={q.id} className="question-card">
            <div className="question-header">
               ...
               <div className="badge badge-warning score-badge">
                 {q.score} XP
               </div>
            </div>
      ...
      {/* Persistent Action Bar - Fixed at Bottom */}
      <div className="quiz-footer">
        <div className="footer-status desktop-only">
           {error ? (
             ...
             <div className="status-save">
               <span>🛡️</span> Your progress is saved
             </div>
           )}
        </div>
        ...
        >
          {answeredCount < questionsCount ? `${questionsCount - answeredCount} Pending` : 'Submit Final Results'}
        </button>
      </div>
      ...
      <style>{`
        ...
        .choice-item.selected .choice-content {
          color: var(--accent);
        }
